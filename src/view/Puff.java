 ...
 * Particle class.
 *
 * Classe générant les particules de simulation de poussières
 *  lors du déplacement de la voiture
 */
public class Puff extends Particle {
    ...
    public Puff(PisteView pisteView, double x, double y, Position velocity) {
        super(pisteView, x, y);
